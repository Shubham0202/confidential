...
const LoggedIn = () => {
  ...
  return (
    ...
    <div ref={popup} className="profile-info hidden absolute right-3 top-16 w-48 sm:w-72 min-h-40 shadow border-2 border-gray-100 rounded-lg p-2 transition-all duration-200">
